...
sa_ivariable::sa_ivariable(sa_base& _sa, int _flags)
	: sa_itext(_sa, _flags)
{
...
sa_ivariable::~sa_ivariable()
{
}

bool sa_ivariable::to_fields(const input_record_t& input_record)
{
...
DECLARE_SA_INPUT(0, sa_ivariable)
